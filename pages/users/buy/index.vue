    ...
    <div class="max-w-8xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
      ...
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full bg-white rounded-lg shadow-lg p-6">
          <h2
            class="text-2xl font-bold text-center text-gray-700 bg-blue-100 py-3 rounded-md mb-6 shadow-inner"
          >
            รายการ PR
          </h2>
                  ...
                  <td class="p-4 border-b border-gray-300 text-center">
                    <div class="flex items-center justify-end gap-3">
                      ...
                      <button
                        ...
                        class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg shadow-md transition duration-300 whitespace-nowrap"
                      >
                        ดาวน์โหลด
                      </button>
                      ...
                      <button
                        ...
                        class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md transition duration-300 whitespace-nowrap"
                      >
                        พรีวิว
                      </button>
                      ...
                      <button
                        ...
                        class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg shadow-md transition duration-300 whitespace-nowrap"
                      >
                        พรีวิว
                      </button>
        ...
        <div class="w-full bg-white rounded-lg shadow-lg p-6">
          <h2
            class="text-2xl font-bold text-center text-gray-700 bg-green-100 py-3 rounded-md mb-6 shadow-inner"
          >
            รายการ PO
          </h2>
          <div class="overflow-x-auto">
